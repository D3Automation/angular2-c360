...
as part of the library.  It is then possible to [override just the template](https://github.com/D3Automation/angular-c360#styling) for the directive (via configuration) without having to implement a custom directive.
